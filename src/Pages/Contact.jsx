      ...
      <motion.div initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true }} className="w-full max-w-lg">
        <div className=" text-gray-900 p-6 rounded-xl shadow-xl">
          ...
          <form className="flex flex-col space-y-4">
            ...
            <input type="email" placeholder="Your Email" className="p-3 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-950" />
            <input type="email" placeholder="Your Mobile Number " className="p-3 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-950" />

            <textarea placeholder="Your Message" className="p-3 border border-slate-200 rounded-lg h-32 focus:outline-none focus:ring-2 focus:ring-blue-950"></textarea>
