...
const DashHome = () => {
  ...
  return (
    <div className=" flex flex-col items-center justify-center bg-slate-100 p-6 w-full mt-5">
      <section className="grid grid-cols-3 gap-6 mb-6">
        <div className="stat bg-indigo-400 text-black rounded-2xl">
          <div className="stat-figure text-primary">
            <img src="/assets/Icon/icons8-user-80.png" alt="" className="w-12 h-13" />
          </div>
        ...
        <div className="stat bg-indigo-400 text-black rounded-2xl col-span-2">
          <div className="stat-figure text-primary">
